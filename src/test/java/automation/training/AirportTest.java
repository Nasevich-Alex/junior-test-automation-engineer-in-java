...
public class AirportTest {
    ...
    public void testHasAtLeastOneTransportMilitaryPlane() {
        ...
        Assertions.assertTrue(transportMilitaryPlanes.size() > 0);
    }

    @Test
    public void testGetPassengerPlaneWithMaxCapacity() {
        PassengerPlane expectedPlaneWithMaxPassengersCapacity = airport.getPassengerPlaneWithMaxPassengersCapacity();
        Assertions.assertEquals(expectedPlaneWithMaxPassengersCapacity, planeWithMaxPassengerCapacity);
    }
    ...
    public void testNextPlaneMaxLoadCapacityIsHigherThanCurrent() {
        ...
        Plane nextPane = planesSortedByMaxLoadCapacity.get(1);
        Assertions.assertFalse(currentPlane.getMaxLoadCapacity() > nextPane.getMaxLoadCapacity());
    }

    @Test
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        List<MilitaryPlane> bomberMilitaryPlanes = airport.getBomberMilitaryPlanes();
        Assertions.assertTrue(bomberMilitaryPlanes.size() > 0);
    }
    ...
    public void testHasAtLeastOneUnclassifiedExperimentalPlane(){
        ...
        Assertions.assertFalse(hasUnclassifiedPlanes);
    }
}
